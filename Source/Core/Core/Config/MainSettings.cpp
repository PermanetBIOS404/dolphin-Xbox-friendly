...
const Info<bool> MAIN_WII_SD_CARD_USE_PHYSICAL{
    {System::Main, "Core", "WiiSDCardUsePhysical"}, false};
...
const Info<std::string> MAIN_WII_SD_CARD_PHYSICAL_PATH{
    {System::Main, "General", "WiiSDCardPhysicalPath"}, ""};
